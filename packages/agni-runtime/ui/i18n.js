...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      resume_msg:          'You stopped at step {step} of {total} in this lesson.',
      resume_subtitle:     'Resume keeps your answers so far. Start over clears saved progress on this device.',
      resume_btn:          'Resume lesson',
      restart_btn:         'Start over from beginning',
      next_btn:            'Next',
    ...
    es: {
      ...
      resume_subtitle:     'Continuar conserva tus respuestas. Empezar de nuevo borra el progreso en este dispositivo.',
    ...
    sw: {
      ...
      resume_btn:          'Endelea',
      resume_subtitle:     'Endelea inahifadhi majibu. Anza upya inafuta maendeleo kwenye kifaa hiki.',
    ...
    fr: {
      ...
      resume_subtitle:     'Reprendre garde vos réponses. Recommencer efface la progression sur cet appareil.',
