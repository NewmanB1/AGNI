...
const archetypeMatch   = require('../utils/archetype-match');
...
async function buildLessonIR(lessonData, options) {
  ...
  // ── 1b. Archetype matching ────────────────────────────────────────────────
  // Attach the best-fit pedagogical archetype and coherence score.
  // This enriches the sidecar so theta/navigator can use coherence as a signal.
