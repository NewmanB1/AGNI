...
- **Device binding:** `Hash(Content + NUL + UUID)` signed with Ed25519. Content = canonicalJSON(LESSON_DATA) (narrow scope v2.2). HTML wrapper and external factory files are not signed.
