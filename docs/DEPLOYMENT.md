...
| `AGNI_COMPILE_CONCURRENCY` | `3` | Max parallel lesson compilations. Use `1` for Pi 3 (1GB), `2` for Pi 4 (2GB). See `hub-config.pi.json`. |
| `AGNI_COMPILE_RETRY_AFTER` | `3` | Seconds in Retry-After when compile queue is full (202 response). Clients auto-refresh. |
