...
|-------|--------|----------|
| **verify:core** | Cross-cutting | dead-files, lesson-gen-test-target, dts, innerhtml, factory-order, precache-regression, schema-sync, canonical, node-version-docs, engine-no-ts, skill-dag, run-environments, es5 |
